...
class SynchronizePaguTahunanBalanceFromUpdatePengajuanKeuangan
{
    /**
     ...
     * Handle the event.
     *
     * @param  PengajuanKeuanganIsUpdated  $event
     * @return void
     */
    public function handle(PengajuanKeuanganIsUpdated $event)
    {
