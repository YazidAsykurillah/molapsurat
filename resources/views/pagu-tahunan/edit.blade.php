...
@section('content-header')
  <div class="row mb-2">
    <div class="col-md-6">
      <h1 class="m-0 text-dark">Edit Pagu Tahunan</h1>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Form Edit Pagu Tahunan</h3>
          <div class="card-tools"></div>
        </div>
        <div class="card-body">
          <form id="form-edit" action="{{ url('pagu-tahunan', [$pagu_tahunan->id]) }}" class="form form-horizontal" method="POST">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                <select class="form-control" name="tahun">
                  ...
                  <option value="{{ $year }}" {{ $pagu_tahunan->tahun == $year ? 'selected': '' }}>{{$year}}</option>
                  @endforeach
                </select>
                @if ($errors->has('tahun'))
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                <input id="jumlah_anggaran" type="text" class="form-control{{ $errors->has('jumlah_anggaran') ? ' is-invalid' : '' }}" name="jumlah_anggaran" value="{{ old('jumlah_anggaran') ? old('jumlah_anggaran') : $pagu_tahunan->jumlah_anggaran }}">
