  ...
  <div class="row mb-2">
    ...
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="{{ url('surat-tugas/'.$surat_tugas->id.'') }}">{{ $surat_tugas->id }}</a></li>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <form id="form-edit" action="{{ url('surat-tugas', [$surat_tugas->id]) }}" class="form form-horizontal" method="POST">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                <input id="nomor" type="text" class="form-control{{ $errors->has('nomor') ? ' is-invalid' : '' }}" name="nomor" value="{{ old('nomor') ? old('nomor') : $surat_tugas->nomor }}">
                @if ($errors->has('nomor'))
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                <input id="tanggal" type="text" class="form-control{{ $errors->has('tanggal') ? ' is-invalid' : '' }}" name="tanggal" value="{{ old('tanggal') ? old('tanggal') : $surat_tugas->tanggal }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                <select name="jenis_surat_tugas_id" id="jenis_surat_tugas_id" class="form-control">
                  <option value="{{ $surat_tugas->jenis_surat_tugas->id }}" selected>{{ $surat_tugas->jenis_surat_tugas->judul }}</option>
                </select>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                <select name="tujuan_surat_tugas_id" id="tujuan_surat_tugas_id" class="form-control">
                 <option value="{{ $surat_tugas->tujuan_surat_tugas->id }}" selected>{{ $surat_tugas->tujuan_surat_tugas->nama }}</option>
                </select>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                <input id="tanggal_mulai" type="text" class="form-control{{ $errors->has('tanggal_mulai') ? ' is-invalid' : '' }}" name="tanggal_mulai" value="{{ old('tanggal_mulai') ? old('tanggal_mulai') : $surat_tugas->tanggal_mulai }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                <input id="tanggal_selesai" type="text" class="form-control{{ $errors->has('tanggal_selesai') ? ' is-invalid' : '' }}" name="tanggal_selesai" value="{{ old('tanggal_selesai') ? old('tanggal_selesai') : $surat_tugas->tanggal_selesai }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
               <table class="table" id="table-team">
                 ...
                 <tbody>
                  @if($surat_tugas->users)
                    @foreach($surat_tugas->users as $stu)
                    <tr>
                     <td>
                      <select name="user_id[]" class="form-control select2-user" required>
                        <option value="{{ $stu->pivot->user_id }}">{{ $stu->name }}</option>
                      </select>
                     </td>
                     <td>
                      ...
                      <select name="position[]" class="form-control select2-position" required>
                        ...
                        @if(count($position_options))
                          ...
                          <option value="{{ $pos }}" {{($stu->pivot->position == $pos ? "selected":"")}} >{{$pos}}</option>
                          @endforeach
                        @endif
                      </select>
                     </td>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <textarea name="uraian" class="form-control">{{ old('uraian') ? old('uraian') : $surat_tugas->uraian }}</textarea>
                <span class="d-block invalid-feedback" role="alert">
